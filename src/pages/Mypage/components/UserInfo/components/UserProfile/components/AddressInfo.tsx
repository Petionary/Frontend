...
import { IUserProfile } from '../../../../../../../utils/type';

interface AddressInfoProps {
  user: IUserProfile;
  // eslint-disable-next-line no-unused-vars
  onChangeInput: (e: ChangeEvent<HTMLInputElement>) => void;
  setInput: React.Dispatch<React.SetStateAction<IUserProfile>>;
  editToggle: boolean;
}
...
const AddressInfo = ({ user, onChangeInput, setInput, editToggle }: AddressInfoProps) => {
  ...
  const handleComplete = (data: Address) => {
    ...
    setInput({ ...user, address: address, postcode: postCode, detailAddress: '' });
  };
