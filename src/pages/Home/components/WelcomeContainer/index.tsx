...
const WelcomeContainer = () => {
  return (
    <section className="h-[calc(100vh-100px)] w-[80vw] mx-auto border-b flex flex-col justify-around relative snap-start snap-always">
      <h1 className="text-gray-100 text-[6.25rem] font-[700] leading-[7.5rem] -tracking-[0.03125rem]">
