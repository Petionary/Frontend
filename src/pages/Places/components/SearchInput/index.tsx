...
const SearchInput = () => {
  return (
    <div className="relative flex w-[35rem] z-10 justify-between sm:w-full sm:justify-center">
      ...
      />
      <div className="h-[3.5rem] w-[3.5rem] bg-primary border-2 rounded-full flex items-center justify-center sm:absolute sm:right-[2.25rem] sm:border-none sm:bg-transparent">
        <Search />
      </div>
    </div>
  );
